...
for lambda = lambda_seq
    ...
    for i = 1:iteration_num
        disp("Quasi-geodesic NO."+i+" @ lambda = "+lambda);
...
save(fullfile(folder_path, 'lambda_test_results.mat'), '-struct', 'results');
